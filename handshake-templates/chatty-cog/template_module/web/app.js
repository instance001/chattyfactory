...
const STORAGE_KEY = "chattycog.template_module.webview.v1";
...
function refreshDerivedUi() {
  ...
  document.getElementById("bridge-status").textContent = window.chattyCogBridge?.available ? "hosted" : "standalone";
