...
impl TemplateNativeApp {
    fn new() -> Self {
        ...
        let mut app = Self {
            state_path,
            bridge_status_path: std::env::var_os("CHATTYCOG_BRIDGE_STATUS").map(PathBuf::from),
    ...
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        egui::SidePanel::left("sidebar")
            ...
            .show(ctx, |ui| {
                ...
                ui.add_space(8.0);
                ui.label("This starter keeps app state in `state.json` and only reports through the optional ChattyCog bridge when hosted.");
            });
        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            ui.columns(2, |columns| {
                ...
                columns[1].label("This is the kind of summary/snapshot ChattyCog can read when the module is hosted.");
