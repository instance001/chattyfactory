...
- [ ] Remove invalid characters from main.py | apply_patch main.py | patch: @@ -4,7 +4,1 @@\n- __ __\n- �� ��\n- �� �� ���_ ���_���_  ���_    _���� ����_ ����_\n- �� �� _���� �� �� �� _����    ��    �� �� �� ��\n- �� �� ��_�� �� �� �� ��_�� �� ����� ����� ����__ | verify: exists path main.py
...
- [ ] Verify project contract | run py -3 ProjectSpec.json | verify: exists path ProjectSpec.json
- [ ] Ensure project directory structure | ensure_dir . | verify: exists path ProjectSpec.json
